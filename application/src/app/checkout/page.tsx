          ...
          <div className="flex flex-col lg:flex-row mx-4 lg:mx-14 gap-20 my-4 lg:my-16 text-white ">
            ...
            <div className="w-full flex flex-col">
              <form className="w-full flex gap-8 flex-col lg:flex-row">
                ...
                <div className="flex flex-col w-full lg:w-1/2">
                  <div
                    className="gradient-border pt-16 pb-14 px-10 hidden lg:flex flex-row justify-between"
                  >
                    <div className="flex flex-col">
                  ...
                  >
                    ...
                    <button
                      className="py-7 px-8 lg:px-28 font-bold text-xl rounded-md mb-14 gradient-button"
                      type="button"
