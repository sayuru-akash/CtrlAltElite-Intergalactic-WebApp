...
export default function Payment() {
  return (
    <section>
      <div
        className="relative flex flex-col items-center justify-end h-[700px] px-9 lg:px-14"
        style={{
      ...
      <div className="flex flex-col lg:flex-row mx-4 lg:mx-14 gap-20 my-4 lg:my-16 text-white ">
        ...
        >
          ...
          <div className="flex flex-col">
            <p className="font-bold text-xl  mb-7">
              <span className="text-sm">Lockheed Dreamcatcher</span>
              <br />
              Earth to Pandora
            </p>
            <p className="font-semibold text-sm mb-5">
              Departure Date: <span className="font-light">25th Aug, 3158</span>
            </p>
            <p className="font-semibold text-sm mb-5">
              No. of Passengers: <span className="font-light">7</span>
            </p>
            <p className="font-semibold text-sm mb-5">
              Travel Time: <span className="font-light">14 Days</span>
            </p>
          </div>
        </div>
        <div className="flex flex-col w-full lg:w-1/2">
          <p className="mb-7 font-bold text-2xl">Personal Information</p>
          <form action="">
            <input
              type="text"
        ...
        <div className="flex flex-col w-full lg:w-1/2 sm :hidden">
          ...
          >
            <div className="flex flex-col">
              <p className="font-bold text-4xl  mb-7">
                <span className="text-xl">Lockheed Dreamcatcher</span>
                <br />
                Earth to Pandora
              </p>
              <p className="font-semibold text-base mb-5">
                Departure Date:{" "}
                <span className="font-light">25th Aug, 3158</span>
              </p>
              <p className="font-semibold text-base mb-5">
                No. of Passengers: <span className="font-light">7</span>
              </p>
          ...
          <div
            className="flex flex-col content-center justify-center px-7 gradient-border"
          >
            ...
            <button
              className="py-7 px-28 font-bold text-xl rounded-md mb-14 gradient-button"
            >
              Complete Payment
            </button>
          </div>
