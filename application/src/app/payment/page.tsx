      ...
      <div className="relative flex flex-col items-center justify-end h-[700px] px-9 lg:px-14" style={{ backgroundImage: `url(/images/pandora.png)`, backgroundSize: "cover", backgroundPosition: "center" }}>
       ...
       <div className="flex flex-col lg:flex-row mx-4 lg:mx-14 gap-20 my-4 lg:my-16 text-white ">
            ...
            <div className="flex flex-col w-full lg:w-1/2">
                ...
                <form action="">
                    <input type="text" placeholder="First Name" className="mb-8 bg-neutral-900 border  text-white rounded-lg p-5 font-light text-xl border-0.5 border-white w-full"/>
                    <input type="text" placeholder="Last Name" className="mb-8 bg-neutral-900 border  text-white rounded-lg p-5 font-light text-xl border-0.5 border-white w-full"/>
                    ...
                    <input type="text" placeholder="Universal Identification Number" className="mb-8 bg-neutral-900 border  text-white rounded-lg p-5 font-light text-xl border-0.5 border-white w-full"/>
                    <input type="text" placeholder="Planet of Residency" className=" bg-neutral-900 border  text-white rounded-lg p-5 font-light text-xl border-0.5 border-white w-full"/>
                </form>
            </div>
