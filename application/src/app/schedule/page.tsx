import { faCalendar, faSearch, faUsers } from "@fortawesome/free-solid-svg-icons";
        ...
        <div className="mx-9 lg:mx-14 flex flex-col">
            ...
            id="glowing-border">
                <div className="flex flex-row justify-between items-center">
                    <FontAwesomeIcon icon={faCalendar} className="text-3xl px-3.5"/>
                ...
                <div className="w-0.5 h-16 bg-gray-500 sm:mx-3.5"></div>
                    <FontAwesomeIcon icon={faUsers} className="text-3xl px-3.5"/>
                    <div className="flex flex-col px-3.5">
                        <p className="font-extralight  text-sm lg:text-xl">
                            Departure Date
                        </p>
